//implementing deletion of a node from a LinkedList
...
public class LinkedList_D
{
	...
	public static LinkedList_D insertion(LinkedList_D list, int data)
	{
	...
	//printing method
	public static void printing(LinkedList_D list)
	{
		Node curr= list.head;
	...
	public static LinkedList_D deletion(LinkedList_D list,int val)
	{
